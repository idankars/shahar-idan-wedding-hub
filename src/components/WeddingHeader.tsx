    ...
    <div className="relative overflow-hidden bg-card border-b border-border">
      ...
      <div className="relative z-10 py-10 md:py-14 text-center">
        <div className="ornament-divider mb-4">
          <svg width="14" height="14" viewBox="0 0 14 14" className="text-primary/60" fill="none">
            <path d="M7 1 L8.5 5.5 L13 7 L8.5 8.5 L7 13 L5.5 8.5 L1 7 L5.5 5.5 Z" stroke="currentColor" strokeWidth="0.8" strokeLinejoin="round" />
          </svg>
        </div>
        ...
        <h1 className="text-5xl md:text-6xl font-display text-foreground mb-3 tracking-tight">
          שחר <span className="inline-block text-primary mx-2 animate-heart-beat">♥</span> עידן
        </h1>
